...
import 'package:elmazr3a/custom/device_info.dart';
import 'package:elmazr3a/custom/fade_network_image.dart';
import 'package:elmazr3a/custom/lang_text.dart';
import 'package:elmazr3a/custom/useful_elements.dart';
import 'package:elmazr3a/data_model/delivery_info_response.dart';
import 'package:elmazr3a/repositories/shipping_repository.dart';
import 'package:elmazr3a/screens/checkout.dart';
import 'package:flutter/cupertino.dart';
import 'package:flutter/material.dart';
import 'package:elmazr3a/my_theme.dart';
import 'package:flutter_icons/flutter_icons.dart';
import 'package:elmazr3a/helpers/shared_value_helper.dart';
import 'package:elmazr3a/repositories/address_repository.dart';
import 'package:elmazr3a/helpers/shimmer_helper.dart';
import 'package:elmazr3a/custom/toast_component.dart';
...
/*
  ...
  Widget build(BuildContext context) {
    ...
    mWidth = MediaQuery
        ...
        .size
        .width;
    final hours = dateTime.hour.toString().padLeft(2, '00');
    final minute = dateTime.hour.toString().padLeft(2, '00');
    final second = dateTime.second.toString().padLeft(2, '00');
          ...
          return Theme(
            data: Theme.of(context).copyWith(
              colorScheme: ColorScheme.light(
                ...
                onSurface: MyTheme.accent_color_shadow,
              ),
...
*/
    ...
    if (is_logged_in.$ == false) {
      ...
      return ListView.separated(
        ...
        itemBuilder: (context, index) {
          return Column(
            children: [
              buildPickupPointItemCard(index, sellerArrayIndex),
            ],
          );
        },
      );
  ...
  Widget buildChooseDateAndTime(BuildContext context) {
    var n =
    ...
    return Container(
      ...
      child: Column(
        ...
        children: <Widget>[
          Row(
            children: [
              ...
              TextButton(
                  ...
                  child: Text(
                    n == "2023-1-1 12:0:0" ? "Select Date" : "${dateTime
          ...
          Row(
            children: [
              ...
              TextButton(
                ...
                style: ButtonStyle(
                    backgroundColor: MaterialStateProperty.all(MyTheme.amber.withOpacity(0.7)),),
                    onPressed: () async {
                      ...
                      setState(() {
                        ...
                        selectedDate.$ = newDateTime.toString();
                      });
                    },
                    child: Text(
                      n == "2023-1-1 12:0:0" ? "Select Time" : "${dateTime
          ...
          SizedBox(height: 20,),
          Text("Your Order will arrive in ${n == "2023-1-1 12:0:0" ? "yyyy-mm-dd hh-mm-ss" : n } ${dateTime.hour > 12
              ? "PM"
              : "AM"}"),
        ],
      ),
  ...
  Column buildCartSellerListItem(int index, BuildContext context) {
    return Column(
      ...
      children: [
        ...
        _sellerWiseShippingOption[0].shippingOption ==
            ShippingOption.PickUpPoint
            ? buildChooseDateAndTime(context)
            : Container(),
        SizedBox(
          height: 5,
        ),
