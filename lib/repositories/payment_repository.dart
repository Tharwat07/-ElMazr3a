...
import 'dart:convert';
import 'package:elmazr3a/data_model/payment_type_response.dart';
import 'package:elmazr3a/data_model/order_create_response.dart';
import 'package:elmazr3a/data_model/paypal_url_response.dart';
import 'package:elmazr3a/data_model/flutterwave_url_response.dart';
import 'package:elmazr3a/helpers/shared_value_helper.dart';
import 'package:elmazr3a/data_model/razorpay_payment_success_response.dart';
import 'package:elmazr3a/data_model/paystack_payment_success_response.dart';
import 'package:elmazr3a/data_model/iyzico_payment_success_response.dart';
import 'package:elmazr3a/data_model/bkash_begin_response.dart';
import 'package:elmazr3a/data_model/bkash_payment_process_response.dart';
import 'package:elmazr3a/data_model/nagad_begin_response.dart';
import 'package:elmazr3a/data_model/nagad_payment_process_response.dart';

import 'package:elmazr3a/data_model/sslcommerz_begin_response.dart';
...
class PaymentRepository {
  ...
  Future<OrderCreateResponse> getOrderCreateResponseFromPayTabs(
      @required payment_method) async {
    var post_body = jsonEncode(
        {"user_id": "${user_id.$}",
