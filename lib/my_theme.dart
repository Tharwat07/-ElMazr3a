...
class MyTheme{
  ...
  static Color accent_color = Color.fromRGBO(178,179,53, 1);
  ...
  static Color splash_screen_color = Color.fromRGBO(178,179,53, 1); // if not sure , use the same color as accent color
