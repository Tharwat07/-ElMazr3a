...
import 'package:elmazr3a/ui_elements/auth_ui.dart';
import 'package:firebase_messaging/firebase_messaging.dart';
import 'package:flutter/gestures.dart';
import 'package:flutter/material.dart';
import 'package:flutter/services.dart';
import 'package:elmazr3a/custom/input_decorations.dart';
import 'package:elmazr3a/custom/intl_phone_input.dart';
import 'package:intl_phone_number_input/intl_phone_number_input.dart';
import 'package:elmazr3a/screens/otp.dart';
import 'package:elmazr3a/screens/login.dart';
import 'package:elmazr3a/custom/toast_component.dart';
import 'package:toast/toast.dart';
import 'package:elmazr3a/repositories/auth_repository.dart';
...
class Gest extends StatefulWidget {
  @override
  _GestState createState() => _GestState();
}
...
class _GestState extends State<Gest> {
  ...
  onPressContinueAsGest() async {
    ...
    var loginResponse = await AuthRepository()
        .getLoginGuestResponse(_login_by == 'email' ? email : _phone, name, phone);
