...
import 'package:elmazr3a/data_model/login_response.dart';
import 'package:elmazr3a/data_model/logout_response.dart';
import 'package:elmazr3a/data_model/signup_response.dart';
import 'package:elmazr3a/data_model/resend_code_response.dart';
import 'package:elmazr3a/data_model/confirm_code_response.dart';
import 'package:elmazr3a/data_model/password_forget_response.dart';
import 'package:elmazr3a/data_model/password_confirm_response.dart';
import 'package:elmazr3a/data_model/user_by_token.dart';
import 'package:flutter/foundation.dart';
import 'dart:convert';
import 'package:elmazr3a/helpers/shared_value_helper.dart';

import '../data_model/singup_gest_response.dart';
...
class AuthRepository {
  ...
  Future<LoginResponse> getLoginGuestResponse(
      @required String email, @required String name,@required String phone ) async {
    var post_body = jsonEncode({
      "email": "${email}",
      "name": "$name",
      "phone": "$phone",
    ...
    Uri url = Uri.parse("${AppConfig.BASE_URL}/auth/guest");
    final response = await http.post(url,
        headers: {
          "Accept": "*/*",
          "Content-Type": "application/json",
  ...
  Future<SignupResponse> getGuestResponse(
      @required String name,
      @required String email_or_phone,
      @required String password,
      @required String passowrd_confirmation,
