...
final SharedValue<String> selectedDate = SharedValue(
  value: "" , // initial value
  key: "selectedDate", // disk storage key for shared_preferences
);

final SharedValue<bool> as_guest = SharedValue(
  value: false, // initial value
  key: "as_guest", // disk storage key for shared_preferences
);
